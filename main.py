...
async def main():
    ...
    btn_left = res["dpad"]["left"].get_rect(top=dpad_y + dpad_size // 2 + spacing, left=dpad_x)
    btn_right = res["dpad"]["right"].get_rect(top=dpad_y + dpad_size // 2 + spacing, left=dpad_x + (dpad_size * 2) + (spacing * 2))
